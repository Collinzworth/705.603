...
MAPPING_PATH = os.getcwd() + "\\generated_models\\dataset\\mapping.pkl"
FEATURES_PATH = os.getcwd() + "\\generated_models\\dataset\\pca_dataset.pkl"
NEAREST_NEIGHBOUR_PATH = os.getcwd() + "\\generated_models\\models\\knn_pca_model.pkl"


SAVE_PATH = os.getcwd() + "\\generated_outputs"

jump_rate = 0.01
num_beats = 20
faded = True

FILENAME = os.getcwd() + "\\generated_outputs\\knn_pca_model\\sound_example.wav"
