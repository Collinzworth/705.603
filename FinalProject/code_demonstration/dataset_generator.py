...
SEGMENT_DIR = os.path.join(os.getcwd(), "code_demonstration\\segmented_songs")
MODEL_DIR = os.path.join(os.getcwd(), "code_demonstration\\models")
MAPPING_INPUT = os.path.join(os.getcwd(), "code_demonstration\\segmented_songs\\mapping.pkl")

PROCESSED_JSON = os.path.join(os.getcwd(), "code_demonstration\Segmented_Files.txt")
PROCESSED_FILE = os.path.join(os.getcwd(), "code_demonstration\Segmented_Files.json")
